...
public class SQLUtilWebSocketGetTableFormsClient extends
    ...
    public SQLUtilWebSocketGetTableFormsClient(
        ...
        super(new GetTableFormsMessageHandler(messageReceivedCallbackParam),
     ...
     *
     */
    private static class GetTableFormsMessageHandler extends GenericListMessageHandler<FormListing>
    {
         ...
         */
        public GetTableFormsMessageHandler(IMessageReceivedCallback<FormListing> messageReceivedCallbackParam) {
