 ...
 *
 * @see JSONObject
 * @see com.fluid.program.api.vo.ws.WS.Path.Role
...
public class RoleClient extends ABaseClientWS {
     ...
     *
     * @see Role
     * @see com.fluid.program.api.vo.role.RoleToFormDefinition
     * @see com.fluid.program.api.vo.role.RoleToFormFieldToFormDefinition
     ...
     * @return Role information.
     *
     * @see com.fluid.program.api.vo.role.RoleListing
     */
