...
public class AutoComplete extends ABaseFluidJSONObject {
	...
	public JSONObject toJsonObject() throws JSONException {
		...
		//Query...
		if (this.getQuery() != null) returnVal.put(JSONMapping.QUERY, this.getQuery());

		//Max Results...
		if (this.getMaxResults() != null) returnVal.put(JSONMapping.MAX_RESULTS, this.getMaxResults());

		//Form Field...
		if (this.getFormField() != null) returnVal.put(JSONMapping.FORM_FIELD, this.getFormField().toJsonObject());

		//Inputs...
		if (this.getExistingValues() != null) {
			JSONArray jsonArray = new JSONArray();
			for (String toAdd : this.getExistingValues()) jsonArray.put(toAdd);
			returnVal.put(JSONMapping.EXISTING_VALUES, jsonArray);
		}
		return returnVal;
	}
}
